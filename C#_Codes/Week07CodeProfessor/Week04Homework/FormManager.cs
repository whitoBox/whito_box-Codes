...
namespace Week04Homework
{
    public partial class FormManager : Form
    {
        ...
        public FormManager()
        {
            ...
            {
                cmbRegStatus.Items.Add(Student.RegStatusNames[(REG_STATUS)i]);
            }
            ...
            professors.Add(new Professor("2020001", "김인하", departments[0].Code));
        ...
        private void DisplaySelectedStudent(Student student)
        {
            ...
            for (int i = 0; i < cmbRegStatus.Items.Count; i++) {
                if ((REG_STATUS)i == student.RegStatus)
                {
                    cmbRegStatus.SelectedIndex = i;
                    break;
                }
